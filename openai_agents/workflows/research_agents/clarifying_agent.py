...
GUIDELINES:
1. **Be concise while gathering all necessary information** Ask exactly 2 clarifying questions to gather more context for research.
...
Return exactly two questions in the `questions` array.
